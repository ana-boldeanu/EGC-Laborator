...
void Lab2::Init()
{
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            // Normally it has 4 vertices
            VertexFormat(glm::vec3(1.5f, 2,  1.5f), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1.5f, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  1.5f), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2.5f, 0,  2.5f), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),

            // Build 2 copies for each vertice to allow coloring each face differently (use 12 vertices)
            VertexFormat(glm::vec3(1.5f, 2,  1.5f), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1.5f, 0,  0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  1.5f), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2.5f, 0,  2.5f), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),

            VertexFormat(glm::vec3(1.5f, 2,  1.5f), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1.5f, 0,  0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  1.5f), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2.5f, 0,  2.5f), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6))
        };

        vector<unsigned int> indices =
        {
            1, 2, 0,    // indices for first triangle
            7, 5, 4,    // indices for second triangle
            11, 8, 10,
            6, 9, 3
        };

        meshes["tetrahedron"] = new Mesh("generated tetrahedron 1");
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 0, 1), glm::vec3(0.25f));
