...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    GLint location_material_shininess = glGetUniformLocation(shader->program, "material_shininess");
    glUniform1i(location_material_shininess, materialShininess);

    GLint location_material_kd = glGetUniformLocation(shader->program, "material_kd");
    glUniform1f(location_material_kd, materialKd);

    GLint location_material_ks = glGetUniformLocation(shader->program, "material_ks");
