    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 forward4 = glm::vec4(forward, 1.0);
            glm::vec4 rotated = glm::rotate(model, angle, right) * forward4;
            forward = glm::normalize(glm::vec3(rotated));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            glm::mat4 model = glm::mat4(1.0f);
            glm::vec4 forward4 = glm::vec4(forward, 1.0);
            glm::vec4 rotated = glm::rotate(model, angle, glm::vec3(0, 1, 0)) * forward4;
            forward = glm::normalize(glm::vec3(rotated));

            glm::vec4 right4 = glm::vec4(right, 1.0);
            rotated = glm::rotate(model, angle, glm::vec3(0, 1, 0)) * right4;
            right = glm::normalize(glm::vec3(rotated));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::mat4 model = glm::mat4(1.0f);
            glm::vec4 right4 = glm::vec4(right, 1.0);
            glm::vec4 rotated = glm::rotate(model, angle, forward) * right4;
            right = glm::normalize(glm::vec3(rotated));
